...
export function ImageUploader() {
  ...
  const handleAddCategory = (id: string) => {
    ...
    if (currentImage && !currentImage.categories.includes(newCategory)) {
      handleUpdateImageField(id, "categories", [...currentImage.categories, newCategory])
    }
    setNewCategory("")
  }
  ...
  return (
    <>
      <h1 className="text-xl font-bold mb-6">Configuração de Imagens do Trabalho</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1 space-y-4">
          ...
          >
            ...
            <p className="text-sm text-center text-muted-foreground">Arraste imagens aqui ou clique para selecionar</p>
          </div>

          <div className="space-y-2">
            <h3 className="text-sm font-medium">Imagens selecionadas ({images.length})</h3>
        ...
        <div className="md:col-span-2">
          {currentImage ? (
              ...
              <div className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleUpdateImageField(currentImage.id, "title", e.target.value)}
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleUpdateImageField(currentImage.id, "description", e.target.value)}
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleUpdateImageField(currentImage.id, "price", e.target.value)}
                    placeholder="0,00"
                    type="number"
                    step="0.01"
                    min="0"
                ...
                <div className="grid gap-2">
                    ...
                    {currentImage.categories.map((category) => (
                      <Badge key={category} variant="secondary" className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          onClick={() => handleRemoveCategory(currentImage.id, category)}
                        >
                          <Trash2 className="h-3 w-3" />
                        </Button>
                      </Badge>
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button type="button" onClick={() => handleAddCategory(currentImage.id)}>
                      Adicionar
                    </Button>
                  </div>
                </div>
            ...
            <div className="flex flex-col items-center justify-center h-full p-12 border-2 border-dashed rounded-lg">
              <ImagePlus className="h-10 w-10 text-muted-foreground mb-2" />
              <p className="text-muted-foreground text-center">Selecione uma imagem para editar seus detalhes</p>
            </div>
          )}
        </div>
      </div>
